...
const Conversation = () => {
  return (
    <Stack height="100%" maxHeight="100vh" width="auto">
      {/* Chat Header */}
      <Box p={2} sx={{ width: "100%", backgroundColor: "#F8FAFF", boxShadow: "0 0 2px rgba(0, 0, 0, 0.25)", }}>
      ...
      {/* Chat Footer */}
      <Box sx={{ height: "100px", width: "100%", backgroundColor: "#F8FAFF", boxShadow: "0 0 2px rgba(0, 0, 0, 0.25)", }}>
